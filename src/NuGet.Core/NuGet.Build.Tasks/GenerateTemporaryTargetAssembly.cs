...
namespace NuGet.Build.Tasks
{
    ...
    /// 
    /// </summary>
    public sealed class GenerateTemporaryTargetAssemblyTask : Task
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        //#region Constructors TODO NK - Do we need a constructor
        ...
        public override bool Execute()
        {
            ...
            try
            {
                ...
                //
                var randProj = Path.ChangeExtension(Path.GetRandomFileName(), TEMP_PROJ_EXT);
                ...
                var globalProperties = new Hashtable(2);
                ...
                try
                {
                    ...
                    // Delete the props and targets from disk
                    foreach (var file in propsAndTargets) { 
                        File.Delete(file);
                    }
                }
                catch (IOException e)
